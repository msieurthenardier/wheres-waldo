...
- [ ] Flight 01: **3D Globe Foundation** — Get a navigable 3D globe rendering in the browser with the command-center aesthetic. Evaluate CesiumJS vs Three.js. Render test ship models and port markers. Establish the visual language.
